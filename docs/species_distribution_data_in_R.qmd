...
Here, we will learn easy first steps for investigating broad distribution patterns, especially helpful when dealing with large scale analysis (e.g. including many species or large geographic areas)
...
-   Trait Data: Table with numerous traits of reptiles from [ReptTraits](https://figshare.com/articles/dataset/ReptTraits_a_comprehensive_database_of_ecological_traits_in_reptiles/24572683) version 1.2
