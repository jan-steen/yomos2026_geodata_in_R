...
-   so called pipelines are written and executed on a file or folder
...
::: fragment
We produce a short pipeline which combines reading an las file and then triangulating the ground points. The result is stored as a raster. Then we execute the pipeline on the file in our filepath.
